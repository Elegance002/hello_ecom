            ...
            <div class="card tab2-card">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs tab-coupon" id="myTab" role="tablist">
                       ...
                       <form method="POST" action="{{ route('staffs.store') }}" class="needs-validation user-add" novalidate="" enctype="multipart/form-data">
                         @csrf
                            ...
                            <div class="tab-pane fade active show" id="account" role="tabpanel"
                                aria-labelledby="account-tab">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" id="validationCustom2" type="text" name="email" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-8 col-md-7">
                                            <input class="form-control" id="validationCustom1" type="text" name="phone" required="">
                                        </div>
                                    </div>
