    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card tab2-card">
                ...
                <div class="card-body">
                    <form class="needs-validation user-add" novalidate="" action="{{ route('roles.store') }}" method="POST">
                        @csrf
                    <div class="form-group row">
                        <label for="validationCustom0"
                            class="col-xl-3 col-md-4"><span>*</span>Name</label>
                        <div class="col-xl-8 col-md-7">
                            <input class="form-control" id="validationCustom0" placeholder="Name"
                                ...
                                <div class="permission-block">
                                    <div class="attribute-blocks">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-9 col-sm-8">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" name="permission[]" value="2">
                                                    <label class="form-check-label"
                                                        for="flexSwitchCheckDefault"></label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-9 col-sm-8">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" name="permission[]" value="3">
                                                    <label class="form-check-label"
                                                        for="flexSwitchCheckDefault"></label>
                                                </div>
                                            </div>
