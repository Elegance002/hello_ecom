...
class CategoryController extends Controller
{
    ...
    {
        //later here should be childrencategory
    ...
    public function store(Request $request)
    {
        ...
        $category_translation = CategoryTranslation::firstOrNew(['category_id' => $category->id]);
        $category_translation->name = $request->name;
        $category_translation->save();

        return redirect()->route('categories.index')->with('success','Category has been inserted successfully');
    }
     ...
     */
     ...
     //here should be  ->with('childrenCategories')
    public function edit($id)
    {
        ...
        return view('backend.product.categories.edit', compact('category', 'categories'));
    }
...
public function update_featured(Request $request, $id)
    {
        $category = DB::table('categories')->select('featured')->where('id', '=', $id)->first();
        if ($category->featured == '1') {
            $featured = '0';
        } else {
            $featured = '1';
        }
        $values = array('featured' => $featured);
